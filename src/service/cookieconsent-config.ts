...
import { HTMLElements } from '../model/html-elements';
import { LocationOptions } from '../model/location-options';
import { LawOptions } from '../model/law-options';
import { ContentOptions } from '../model/content-options';
import { CookieOptions } from '../model/cookie-options';
import { PaletteOptions } from '../model/palette-options';
